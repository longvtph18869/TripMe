          ...
          <form style={{width: "500px", marginLeft:"50px"}}>
            <div className="flex">
              ...
              <div className="relative w-full">
                <input style={{borderRadius:"0", borderTopRightRadius:"10px", borderBottomRightRadius:"10px"}} type="search" className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-orange-400 focus:border-orange-400 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-orange-400" placeholder="Tìm theo điểm đến, hoạt động..." required />
                <button type="submit" className="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-orange-400 rounded-r-lg border border-orange-400 hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-orange-400 dark:ring-orange-400 dark:hover:ring-orange-400 dark:focus:ring-orange-400">
